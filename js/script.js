...
async function getAPI1() {
    ...
    try {
        ...
        let cardConteudo = ""
        cardConteudo += `<div class="animeCard" id="${i}">
        ...
        if (dados.data.trailer.embed_url !== undefined){
            cardConteudo += ` <iframe width="300px" height="auto" src="https://www.youtube.com/embed/${videoKey}si=R-EVc6WSTISt_vc8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`
        }
       // alert(cardConteudo)
        animeContainer.innerHTML += `${cardConteudo} <hr> ${i} </div>` 
